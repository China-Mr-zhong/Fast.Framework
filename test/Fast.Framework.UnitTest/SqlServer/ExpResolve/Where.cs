...
namespace Fast.Framework.UnitTest.SqlServer.ExpResolve
{
    ...
    public class Where
    {
        ...
        /// 选项
        /// </summary>
        private readonly ResolveSqlOptions options = new ResolveSqlOptions() { DbType = DbType.SQLServer, UseCustomParameter = false };
