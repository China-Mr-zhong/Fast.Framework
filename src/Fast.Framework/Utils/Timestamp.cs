...
namespace Fast.Framework
{
    ...
    public static class Timestamp
    {
        ...
        {
            return TimeZoneInfo.ConvertTimeFromUtc(startDate.AddSeconds(timestamp), timeZoneInfo ?? TimeZoneInfo.Local);
        }
        ...
        {
            return TimeZoneInfo.ConvertTimeFromUtc(startDate.AddMilliseconds(timestamp), timeZoneInfo ?? TimeZoneInfo.Local);
        }
    }
}
